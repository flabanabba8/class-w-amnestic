...
from skillstate.models.archive import EventType, MemoryResult, RunMetadata
from skillstate.models.common import new_id, utcnow
...
def _env(workspace: Path) -> Any:
    from skillstate.models.state import Environment
