...
Application semantics live in ``skillstate.state.apply``.
"""
...
from skillstate.models.common import Identifier, JsonScalar, ShortText, StrictModel
from skillstate.models.state import PlanStepStatus, RunStatus
